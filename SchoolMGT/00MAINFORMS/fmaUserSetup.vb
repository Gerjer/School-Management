Public Class fmaUserSetup
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If Operation = "ADD" Then
            ...
            If txtUserType.SelectedIndex = 2 Then
                AppSetup_Domain = cmbPerson.SelectedValue
            Else
                AppSetup_Domain = 0
            End If
            ...
            Dim hashedPassword As String = HASH512(txtPasswordChar2.Text, salt) ' txtAdmNum.Text

            Dim SQLIN As String = "INSERT INTO users(username,first_name,last_name,student,admin,employee,hashed_password,salt,application_setup_id,Type_User)"
            SQLIN += " VALUES("
            ...
            Else
                SQLIN += String.Format("'{0}', '{1}',", txtLastName.Text, "0")
                SQLIN += String.Format("'{0}', '{1}',", "1", "0")
            End If

            SQLIN += String.Format("'{0}', '{1}','{2}','{3}')", hashedPassword, salt, AppSetup_Domain, txtUserType.Text)
        ...
        Else
            If MessageBox.Show("Are you sure you want to Update Password?", "Please Verify....", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = DialogResult.Yes Then
                ...
                Dim SQLIN As String = String.Format("UPDATE users SET hashed_password='{0}', salt='{1}',username = '{2}',application_setup_id ='{3}',Type_User ='{4}' WHERE id='{5}'", hashedPassword, salt, txtUserName.Text, AppSetup_Domain, txtUserType.Text, txtUserID.Text)
    ...
    Private Sub fmaUserSetup_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Else
            cmbPerson.SelectedValue = AppSetup_Domain
    ...
    Private Sub loadComboBox(type As Integer)
        ...
        Select Case type
            Case 1
                cmbPerson.DataSource = getEmployeeName_global()
        ...
        '            cmbPerson.DataSource = getEmployeeName_global()
        '#Region "old"
        '            'DataSource(String.Format("SELECT
        '            '                                    employees.id 'id',
        '            '                                    person.display_name 'name',
        '            '                                    person.first_name,
        '            '                                    person.last_name
    ...
    Private Sub RadioButton3_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton3.CheckedChanged
        ...
        loadComboBox(RadioButton3.Tag)
    End Sub

    Private Sub cmbPerson_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPerson.SelectedIndexChanged
        Try
            Dim drv As DataRowView = DirectCast(cmbPerson.SelectedItem, DataRowView)
            txtFirstName.Text = drv.Item("first_name")
            txtLastName.Text = drv.Item("last_name")
