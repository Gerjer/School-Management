...
#Region "Classes"
    ...
    Private Sub getDropDownList()
        ...
        MeData = Nothing
        SQL = "SELECT SysPK_Item,name FROM rooms ORDER BY Item_Code"
...
#End Region
    ...
    Private Sub txtemployee_name_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtemployee_name.SelectedIndexChanged
        Try
            ...
            Me.txtemployee_name.Text = drv.Item("EMPNAME").ToString
        Catch ex As Exception
            Me.txtemployee_id.Text = ""
        End Try
    End Sub
...
"))
    ...
    Private Sub getDuplicateSchedule()
        ...
        Dim Activate As String = DataObject(String.Format("SELECT activate FROM _checking"))
