...
#Region "Classes"
    Private Sub AttachClasses()
        ...
        clsGroup.AttachControl = Me.txtdean_name
...
#End Region
    ...
    Private Sub txtcategory_name_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtcategory_name.SelectedIndexChanged
        Try
            ...
            If txtcategory_name.Text = "COLLEGE" Then
                LabelX1.Text = "COURSE CODE"
                LabelX7.Text = "COURSE NAME"
                btnCourselist.Enabled = True
            Else
                LabelX1.Text = "GRADE CODE"
                LabelX7.Text = "GRADE NAME"
                btnCourselist.Enabled = False
            End If
