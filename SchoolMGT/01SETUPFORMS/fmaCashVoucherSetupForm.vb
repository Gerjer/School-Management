...
Public Class fmaCashVoucherSetupForm
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim finance_type As String = "CASH/CHECK VOUCHER"
        ...
        SQLIN += " ,finance_type, address, voucher_no, bank,acctno)"
        SQLIN += " VALUES("
        ...
        SQLIN += String.Format(",'{0}', '{1}', '{2}','{3}','{4}')", finance_type, Me.address.Text, generateVoucherNumber, Me.txtBankName.Text, Me.txtAcctNum.Text)
        ...
        If clsDBConn.Execute(SQLIN) Then
            ...
            new_report.AttachReport(SQLEX, "CASH/CHECK VOUCHER") = New rpt_CashVoucher()
            new_report.Show()
        End If
    End Sub
