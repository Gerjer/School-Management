...
Public Class fmaStudentsGradingPeriod
    ...
    Private Sub createHeader()
        ...
        dt_grade = dgvSubjectGrade.DataSource

        Dim SQLEX As String = "SELECT id, name FROM student_grading_period"
        SQLEX += " WHERE student_category_id='" & txtCatID.Text & "'  AND is_deleted = 0"
        ...
        For jRows As Integer = 0 To rowCount
            ...
            For pCount As Integer = 4 To GRADINGPERIOD
                ...
                If MeData.Rows.Count > 0 Then
                    ...
                    '      Else
                    '         dgvSubjectGrade.Item(pCount, jRows).Value = ""
                    '       dtsubjectgrades.Rows(jRows).Item(pCount) = 0
                End If
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        If AuthUserType <> "ADMIN" Then
            MsgBox("CANNOT PRINT..!!! PLS CONTACT SYSTEM ADMINISTRATOR.", MsgBoxStyle.Critical, "SYSTEM ADMINISTRATOR")
        ...
        dt = LoadStudentSubjectNew(txtStudentID.Text)
        '
        If dt.Rows.Count > 0 Then
            ...
            For Each row As DataRow In dt.Rows
                ...
                With obj
                    ...
                    .equivalent = If(IsDBNull(row("EQUIVALENT")), "", row("EQUIVALENT"))
            ...
            Dim report As New xtrGradeSlipNew
...
#End Region
    ...
    Private Function LoadStudentSubjectNew(student_id As String) As DataTable
        Dim sql As String = ""
        sql = "SELECT DISTINCT
			  stdID,	
				stdNumber,
				...
				IFNULL(equivalent,'') 'EQUIVALENT',
				IFNULL(finalremarks,'') 'REMARKS',
