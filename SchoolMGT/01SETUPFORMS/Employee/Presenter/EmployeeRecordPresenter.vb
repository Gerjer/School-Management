...
Public Class EmployeeRecordPresenter
    ...
    Private Sub EducationalAttainment_ColumnHeader()
        ...
        dt_EducationalAttainment.Columns.Add("School Address")
    ...
    Private Function AutoGenerated_Employeenumber()
        ...
        Try
            If Not RecordModel.getLastEmplNumber() Is Nothing Then
                lastNumber = RecordModel.getLastEmplNumber()
                ...
                Try
                    ...
                    For Each rows As DataRow In dt_EducationalAttainment.Rows
                        ...
                        With obj
                            ...
                            .SchoolAddress = rows.Item("School Address").ToString
