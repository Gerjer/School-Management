...
#Region "Viewers Info"
    ...
    Private Sub Attach()
        ...
        SQL += " FROM " & TABLENAME
        SQL += " WHERE SysPk <> 0 ORDER BY school_year DESC,year_level,name "
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("coursename").DataColumn.Caption = "COURSE/GRADE NAME"
                ...
                .DisplayColumns("name").DataColumn.Caption = "BATCH/SECTION NAME"
...
#End Region
    ...
    Private Sub fmaDepartmentViewerListForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        _student_category_id = RadioButton3.Tag
    ...
    Private Sub loadSchoolYear()
        ...
        cmbYear.DataSource = DataSource(String.Format("SELECT DISTINCT
                1 as 'id',
    ...
    Private Sub loadComboBox()
        ...
        cmbCourse.DataSource = DataSource(String.Format("SELECT
                            ...
                            FROM
	                            courses
                            WHERE
	                            courses.is_deleted = 0 And category_id = '" & _student_category_id & "'"))
    ...
    Private Sub searchFilterText()
        ...
        Dim SQL As String = "SELECT SysPk,id,course_id,coursename,name,year_level,school_year,semester,grade_dist_from,grade_dist_to"
        SQL += " FROM " & TABLENAME
        SQL += " WHERE SysPk <> 0 AND" & Me.txtFilterText.Text
        SQL += " ORDER BY name "
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaBatchesSetupForm
            SETUPFORM.txtschool_year1.Value = school_year
            SETUPFORM.batch_name = batch_name
    ...
    Private Sub tdbViewer_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles tdbViewer.MouseUp
        If e.Button = Windows.Forms.MouseButtons.Left Then
            ...
            Try
                ...
                school_year = tdbViewer.Item(row, "SCHOOL YEAR")
                batch_name = tdbViewer.Item(row, "BATCH/SECTION NAME")
            Catch ex As Exception
    ...
    Private Sub cmbCourse_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCourse.SelectedIndexChanged
        If FirstLoad = False Then
            Try
                loadBatch(cmbCourse.SelectedValue)
            Catch ex As Exception
    ...
    Private Sub loadBatch(selectedValue As Object)
        ...
        Dim SQL As String = "SELECT SysPk,id,course_id,coursename,name,year_level,school_year,semester,grade_dist_from,grade_dist_to"
        SQL += " FROM " & TABLENAME
        SQL += " WHERE SysPk <> 0 AND course_id = '" & selectedValue & "' and school_year = '" & cmbYear.Text & "' "
        SQL += " ORDER BY school_year DESC,year_level,name "
    ...
    Private Sub RadioButton3_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton3.CheckedChanged
        Dim rdbtn As RadioButton = sender
        _student_category_id = rdbtn.Tag
        loadComboBox()
    End Sub
