...
Public Class BillingStatementPresenter
    ...
    Private Sub SelectRow(sender As Object, e As RowCellClickEventArgs)
        ...
        Semister = If(IsDBNull(_view.gvBillingStatement.GetFocusedRowCellValue("SEMISTER")), "", _view.gvBillingStatement.GetFocusedRowCellValue("SEMISTER"))


        'AcademicYear = _view.gvBillingStatement.GetFocusedRowCellValue("ACADEMIC YEAR")
        AcademicYear = If(IsDBNull(_view.gvBillingStatement.GetFocusedRowCellValue("ACADEMIC YEAR")), "", _view.gvBillingStatement.GetFocusedRowCellValue("ACADEMIC YEAR"))
    End Sub
