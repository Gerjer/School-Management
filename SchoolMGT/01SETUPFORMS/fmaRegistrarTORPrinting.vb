    ...
    Private Sub getStudentSubjectList()
        ...
        dt = DataSource(String.Format("SELECT
		  ...
		  INNER JOIN courses ON students.course_id = courses.id
			...
			ORDER BY batches.school_year ASC,batches.year_level ASC,batches.semester ASC
...
#End Region
        If dt.Rows.Count > 0 Then
            ...
            _class_roll_no = dt(0)("class_roll_no")
            txtClassrollNumber.Text = dt(0)("class_roll_no")
            GridControl1.DataSource = dt

            GridView1.Columns("CourseName").GroupIndex = 0
            GridView1.Columns("BatchName").GroupIndex = 1
            GridView1.Columns("description").GroupIndex = 2
            '      GridView1.Columns("school_year").GroupIndex = 3
...
"))
    ...
    Private Sub GridView1_CellValueChanged(sender As Object, e As DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs) Handles GridView1.CellValueChanged
        ...
        Dim equivalent = DataObject(String.Format("SELECT ratings FROM grading_system WHERE equivalent = '" & e.Value & "'"))
        If equivalent Is Nothing Then
            equivalent = "5.0"
        End If
        DataSource(String.Format("UPDATE students_subjects SET re_exam = '" & e.Value & "',equivalent = '" & equivalent & "' WHERE id = '" & GridView1.GetFocusedRowCellValue("StdSubjectID") & "'"))
    ...
    Public Sub ToolTipController1_GetActiveObjectInfo_1(sender As Object, e As ToolTipControllerGetActiveObjectInfoEventArgs) Handles ToolTipController1.GetActiveObjectInfo
        ...
        If hi.InRow = True Then
            ...
            Dim text As String = "To Add Re-Exam Grade, Double click column row 'Re-Exam' then do Entry.."   '+ hi.RowHandle.ToString()
    ...
    Dim TOR As New TORDetails

    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Cursor.Current = Cursors.WaitCursor

        '      TOR.PreviewTOR(PERSON_ID, txtPurpose.Text)
