...
#End Region
            ...
            SQLEX += " FROM students "
            SQLEX += " INNER JOIN person ON ( students.person_id = person.person_id ) "
            SQLEX += " INNER JOIN students_subjects ON students_subjects.student_id = students.id "
            SQLEX += " INNER JOIN subjects ON subjects.batch_id = students.batch_id "
            SQLEX += " LEFT JOIN subject_class_schedule ON subject_class_schedule.subject_id = subjects.id"
            SQLEX += " WHERE students.course_id='" & txtCourseID.Text & "'"
            SQLEX += " AND subjects.is_deleted <> '1' and students.is_enrolled ='1'"
            ...
            SQLEX += " ORDER BY subjid, person.last_name, person.first_name"
