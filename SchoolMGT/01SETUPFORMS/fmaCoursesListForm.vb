...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT id,code,course_name,section_name,category_id,SysPK,description,category_name,dean_name "
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("dean_name").DataColumn.Caption = "DEAN'S HEAD"
                .DisplayColumns("dean_name").Width = 150
                .DisplayColumns("dean_name").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("dean_name").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
            End With
