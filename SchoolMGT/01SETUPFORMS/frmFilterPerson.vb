...
Public Class frmFilterPerson
    ...
    Private Sub frmFilterPerson_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        GridControl1.DataSource = _dt_filter_student
...
#End Region
        sql = "SELECT
                ...
                GROUP BY person_id
                                        "
        dt = clsDBConn.ExecLongQuery(sql)
    ...
    Private Sub btnSelect_Click(sender As Object, e As EventArgs) Handles btnSelect.Click
        ...
        PERSON_ID = GridView1.GetFocusedRowCellValue("person_id")
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        Else
            MessageBox.Show("Pls...Select STUDENT on the list to Edit..!", "INVALID TASK")
        End If
