...
#Region "Viewers Info"
    ...
    Public Sub Attach()
        ...
        SQL += " receipt_no,amount,SUBSTR(title,16)'title',finance_transactions.description 'ft_description'"
        SQL += " FROM " & TABLENAME
        ...
        Else
            SQL += " AND transaction_date between '" & Format(dtpFrom.Value, "yyyy-MM-dd") & "' and '" & Format(dtpTo.Value, "yyyy-MM-dd") & "' "
        End If
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("date_issued").Width = 200
                ...
                .DisplayColumns("receipt_no").Width = 250
                ...
                .DisplayColumns("title").Width = 400
...
#End Region
    ...
    Public Sub LoadRequesList()
        ...
        Else
            SQL += " WHERE date_filed between '" & Format(dtpFrom.Value, "yyyy") & "' and '" & Format(dtpTo.Value, "yyyy") & "' "
        End If
        ...
        Try
            ...
            With tdbViewer1.Splits(0)
                ...
                .DisplayColumns("date_filed").Width = 200
                ...
                .DisplayColumns("date_due").Width = 200
                ...
                .DisplayColumns("claim_window").Width = 200
                ...
                .DisplayColumns("no_of_copies").Width = 200
...
#End Region
    ...
    Private Sub SETUPFORM_INCOME_SETUP_CLOSING() Handles SETUPFORM.INCOME_SETUP_CLOSING
        SETUPFORM = Nothing
    End Sub

    Private Sub cmbFilter_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbFilter.SelectedIndexChanged

        If cmbFilter.Focused = True Then
