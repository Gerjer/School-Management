...
Public Class rpt_ReceiptPrintout
    ...
    Sub New(ByVal datestr As String, ByVal student_name As String,
            ByVal amount As Double, ByVal paymentType As String, ByVal orNo As String, Optional ByVal feetable As DataTable = Nothing)
        ...
        Me.SubReport1.Report = New subrpt_FeeSubDetails

        Me.SubReport1.Report.DataSource = feetable
