...
Public Class rpt_CollegeStudentAssessmentReport
    ...
    Private Sub GroupFooter1_Format(ByVal sender As Object, ByVal e As System.EventArgs) Handles GroupFooter1.Format
        ...
        '  report_dt_fees(0)(3) = Format(TOTAL_TUITION_FEES, "###,###.00")
    ...
    Private Sub rpt_CollegeStudentAssessmentReport_ReportStart(sender As Object, e As EventArgs) Handles Me.ReportStart
        Dim dt_sigantory As DataTable = getSignatory(5)
        Try
            Label20.Text = dt_sigantory(0)("name")
            Label22.Text = dt_sigantory(0)("designation")

            Label21.Text = dt_sigantory(1)("name")
            Label23.Text = dt_sigantory(1)("designation")
        Catch ex As Exception
