...
Public Class xtrEnrollmentSlip_JuniorG78910
    Private Sub GroupHeader1_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles GroupHeader1.BeforePrint
        ...
        For x As Integer = 0 To dt_subject_global.Rows.Count - 1
            ...
            Select Case Subject
                ...
                Case "Technology Livelihood Education"
                    XrLabel115.Text = If(IsDBNull(dt_subject_global(x)("SUBJECT TITLE")), "", dt_subject_global(x)("SUBJECT TITLE"))
                    XrLabel114.Text = If(IsDBNull(dt_subject_global(x)("TIME")), "", dt_subject_global(x)("TIME"))
                    XrLabel113.Text = If(IsDBNull(dt_subject_global(x)("DAYS")), "", dt_subject_global(x)("DAYS"))
                    XrLabel112.Text = If(IsDBNull(dt_subject_global(x)("INSTRUCTOR")), "", dt_subject_global(x)("INSTRUCTOR"))
                Case "Music"
                ...
                Case "ADV. Science (Genetics)", "ADV. Science (Zoology)", "ADV. Science (Geology)", "ADV. Science (Biotechnology)"
                ...
                Case "ADV.MATH (Algebra 1)", "ADV.MATH (Statistic)", "ADV.MATH (Trigonometric)", "ADV.MATH (Pre-Calculus)"
