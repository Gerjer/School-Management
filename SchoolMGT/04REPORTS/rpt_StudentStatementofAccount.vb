...
Public Class rpt_StudentStatementofAccount
    ...
    Private Sub rpt_StudentStatementofAccount_ReportStart(sender As Object, e As EventArgs) Handles Me.ReportStart
        Dim dt_sigantory As DataTable = getSignatory(6)
        Try
            Label21.Text = dt_sigantory(0)("name")
